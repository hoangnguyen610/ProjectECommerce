...
public class FbLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (action.equals("siginOrSigup")){
            if (customer == null) {
                ...
                if (code == null || code.isEmpty()) {
                    ...
                    if (getCustomer == null){
                        ...
                        url = "/login.jsp";
                        status = "Tài khoản Facebook này chưa được đăng ký";
                    }else {
                        //thủ tục đăng nhập
                ...
                if (code == null || code.isEmpty()) {
                    ...
                    url = "/infor.jsp";
                    status = "Đã thêm đăng nhập nhanh bằng Facebook thành công";
                }
            }
            ...
            url = "/infor.jsp";
            status = "Đã xóa đăng nhập nhanh bằng Facebook thành công";
